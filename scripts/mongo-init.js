...
db.places.createIndex({ source: 1, sourceId: 1 }, { unique: true, sparse: true });
db.places.createIndex({ name: 'text', description: 'text', 'details.address': 'text' });
