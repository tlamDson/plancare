...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  "English (US)": {
    ...
    "trip.actionsMenu": "Actions",
    "trip.menuDurationOneDay": "1 day",
    "trip.menuDurationNDays": "{n} days",
    "trip.lifecycleLabel": "Trip status",
    "trip.calendarSync": "Sync Google Calendar",
    "trip.calendarSyncing": "Syncing…",
    "trip.calendarSyncBetaShort":
      "Calendar sync is in internal beta (VIP).",
    ...
    "trip.weatherMissingConfig":
      "Weather is unavailable. Set OPENWEATHER_API_KEY in .env.docker (Docker) or backend/.env, then recreate/restart the API.",
  ...
  French: {
    ...
    "trip.calendarSync": "Sync Google Calendar",
    "trip.calendarSyncing": "Synchronisation…",
    "trip.calendarSyncBetaShort":
      "Sync calendrier en bêta interne (VIP).",
    ...
    "trip.weatherMissingConfig":
      "Météo indisponible. Ajoutez OPENWEATHER_API_KEY dans .env.docker (Docker) ou backend/.env, puis recréez/redémarrez l’API.",
  ...
  Vietnamese: {
    ...
    "trip.actionsMenu": "Thao tác",
    "trip.menuDurationOneDay": "1 ngày",
    "trip.menuDurationNDays": "{n} ngày",
    "trip.lifecycleLabel": "Trạng thái chuyến",
    "trip.calendarSync": "Đồng bộ Google Calendar",
    "trip.calendarSyncing": "Đang đồng bộ…",
    "trip.calendarSyncBetaShort":
      "Đồng bộ lịch đang beta nội bộ (VIP).",
    ...
    "trip.weatherMissingConfig":
      "Không tải được thời tiết. Thêm OPENWEATHER_API_KEY vào .env.docker (Docker) hoặc backend/.env, rồi recreate/khởi động lại API.",
